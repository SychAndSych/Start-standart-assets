...
{
    [AddComponentMenu("Sych scripts / UI / Illumination button UI")]
    public class Illumination_button_UI : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerEnterHandler, IPointerExitHandler
    {
