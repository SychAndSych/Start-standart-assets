...
public class ShowIfNewAttribute : PropertyAttribute
{
    public ActionOnConditionFail Action {get;private set;}
    public ConditionOperator Operator {get;private set;}
    public string[] Conditions {get;private set;}

    public ShowIfNewAttribute(ActionOnConditionFail action, ConditionOperator conditionOperator, params string[] conditions)
    {
        Action  = action;
...
[CustomPropertyDrawer(typeof(ShowIfNewAttribute), true)]
public class ShowIfAttributeDrawer : PropertyDrawer
{
    ...
    {
        var showIfAttribute = this.attribute as ShowIfNewAttribute;
